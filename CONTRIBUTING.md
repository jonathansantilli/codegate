...
- Use focused commits.
- Use Conventional Commit prefixes (`feat:`, `fix:`, `docs:`, `test:`, `chore:`, etc.). These drive automatic versioning and release.
- Use `!` or `BREAKING CHANGE:` for backwards-incompatible changes.
